...
struct Radio_s
{
     ...
     */
    void    ( *initIRQ )( uint8_t dio0, uint8_t dio1, uint8_t dio2, uint8_t dio3, uint8_t dio4, uint8_t dio5);
    void    ( *initDIO )( uint8_t nss, uint8_t rst, uint8_t ctrl, uint8_t vdd);
    void    ( *init    )( SPIClass* spi, RadioEvents_t *events );
